...
3. Rode os casos base de `../../templates/prompt-injection-eval.md` contra o agente e registre o resultado; acrescente casos especificos das fontes nao confiaveis deste agente.
4. Procure data exfiltration: secrets, tokens, PII, memoria, logs, arquivos locais e respostas do agente.
5. Audite unsafe tool use: permissao excessiva, side effects sem confirmacao, retry perigoso e falta de allowlist.
6. Audite auth/config/logs: env vars, defaults, traces, audit logs, error messages e redaction.
7. Classifique achados por severidade e recomende guardrail, teste e dono.
...
- Casos PI-03, PI-04 e PI-05 do eval de prompt injection precisam passar antes do release; eval nao executado e lacuna declarada, nao aprovacao.

## Arquivos de apoio
- Template: ../../templates/agent-security-report.md
- Eval de prompt injection: ../../templates/prompt-injection-eval.md
